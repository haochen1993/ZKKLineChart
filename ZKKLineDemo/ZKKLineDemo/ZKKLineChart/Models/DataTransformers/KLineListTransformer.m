...
NSString *const kCandlestickChartsContext = @"kCandlestickChartsContext";
NSString *const kCandlestickChartsDate    = @"kCandlestickChartsDate";
NSString *const kCandlestickChartsMaxHigh = @"kCandlestickChartsMaxHigh";
NSString *const kCandlestickChartsMinLow  = @"kCandlestickChartsMinLow";
NSString *const kCandlestickChartsVol = @"kCandlestickChartsVol";
NSString *const kCandlestickChartsRSV9 = @"kCandlestickChartsRSV9";
NSString *const kCandlestickChartsKDJ = @"kCandlestickChartsKDJ";
NSString *const kCandlestickChartsMACD = @"kCandlestickChartsMACD";
NSString *const kCandlestickChartsRSI = @"kCandlestickChartsRSI";
NSString *const kCandlestickChartsBOLL = @"kCandlestickChartsBOLL";
NSString *const kCandlestickChartsDMA = @"kCandlestickChartsDMA";
NSString *const kCandlestickChartsCCI = @"kCandlestickChartsCCI";
NSString *const kCandlestickChartsWR = @"kCandlestickChartsWR";
NSString *const kCandlestickChartsBIAS = @"kCandlestickChartsBIAS";
...
//    NSArray *macd = [self macdWithData:cutRawData];
    ...
    [despString appendFormat:@"Stock Candles: \t\t\t\t%@\n\n\n", items];
...
- (CGFloat)rsv9WithData:(NSArray *)data subInRange:(NSRange)range {
    float rsv9 = 100.0;
...
- (NSArray *)kdjWithRSV9:(NSArray *)rsv9s {
    ...
    // 反转数组数据
    return @[ [[kdj_ks reverseObjectEnumerator] allObjects],
              [[kdj_ds reverseObjectEnumerator] allObjects],
              [[kdj_js reverseObjectEnumerator] allObjects] ];
}
